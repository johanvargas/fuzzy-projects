# THIS REALLY ISN'T TO BE USED, USE THE INDIVIDUAL 'MODULES' FOR EACH OF THE OPERATIONS
# FURTHERMORE, THERE SHOULD BE A CENTRAL INPUT SCRIPT, WHERE ALL MODULES ARE ACCESSABLE 
# AND CAN CLEAN, PARSE AND MOVE DATA ACCORDINGLY. THIS WAS JUST AN INITIAL, TEST SCRIPT 
# TO SEE HOW PYTHON AND POSTGRES WORKED AND CAN BE USED AS A REFERENCE BUT NOTHING MORE.
